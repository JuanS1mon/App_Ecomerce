...
from .schema_facu import FacuBase, FacuCreate, FacuUpdate, FacuRead
from .model_facu import Facu as FacuModel
from .service_facu import create_facu, get_facu, gets_facu, delete_facu, update_facu
...
async def routes_post_facu(facu: FacuCreate, db: Session = Depends(get_db)):
    ...
    try:
        ...
        # Corregir el nombre del parámetro a facu_data
        db_facu = create_facu(db=db, facu_data=facu_model.__dict__)
