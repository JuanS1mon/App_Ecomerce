...
async def get_artists_html(request: Request, db: Session = Depends(get_db)):
    try:
        ...
        return templates.TemplateResponse("app_obras/artists/list.html", {
            "request": request,
            "artists": artists
        })
    except Exception as e:
...
async def get_create_artists_html(request: Request):
    return templates.TemplateResponse("app_obras/artists/create.html", {"request": request})
...
async def get_edit_artists_html(request: Request, id: int, db: Session = Depends(get_db)):
    try:
        ...
        return templates.TemplateResponse("app_obras/artists/edit.html", {
            "request": request,
            "artist": artist
        })
    except HTTPException:
