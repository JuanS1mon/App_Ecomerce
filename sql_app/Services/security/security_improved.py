...
def log_security_event(event_type: str, details: dict, severity: str = "INFO"):
    ...
    for key, value in details.items():
        if key in ["password", "token", "secret"]:
            ...
            safe_details[key] = str(value)[:100]  # Limitar longitud
    
    log_message = f"Security Event: {event_type} | Details: {safe_details}"
...
def revoke_token(token_jti: str):
    """Revocar token JWT (implementación básica)"""
...
# Constantes adicionales requeridas
