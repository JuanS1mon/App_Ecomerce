...
async def get_artwork_states_html(request: Request, db: Session = Depends(get_db)):
    try:
        ...
        return templates.TemplateResponse("app_obras/artwork_states/list.html", {
            "request": request,
...
async def get_create_artwork_states_html(request: Request):
    return templates.TemplateResponse("app_obras/artwork_states/create.html", {"request": request})
...
async def get_edit_artwork_states_html(request: Request, id: int, db: Session = Depends(get_db)):
    try:
        ...
        return templates.TemplateResponse("app_obras/artwork_states/edit.html", {
            "request": request,
