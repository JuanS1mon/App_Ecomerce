...
from sql_app.Services.app_stock.articulos_series.schema_articulos_series import Articulos_seriesCreate, Articulos_seriesUpdate, Articulos_seriesRead
...
from sql_app.Services.app_stock.articulos_series.route_articulos_series import router
