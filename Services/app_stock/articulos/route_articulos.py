...
from .service_articulos import create_articulos, get_articulos, gets_articulos, delete_articulos, update_articulos
...
async def get_pagina():
    try:
        ...
        with open(f"static/articulos/index.html", "r", encoding="utf-8") as file:
