...
from .articulos.route_articulos import router as articulos_router
from .articulos.route_historial_precios import router as historial_router
from .articulos.route_historial_precios import api_router as historial_api_router
from .articulos.route_codigos import router as codigos_router
from .articulos_tipos.route_articulos_tipos import router as articulos_tipos_router
from .articulos_series.route_articulos_series import router as articulos_series_router
# Importar los routers de stock y depósitos
from .stock.route_stock_admin import router as stock_admin_router
from ..app_stock.stock.route_stock import router as stock_router
from ..app_stock.depositos_tipos.route_depositos_tipos import router as depositos_tipos_router
from ..app_stock.depositos.route_depositos import router as depositos_router

# Importar el router de órdenes de trabajo
from ..app_stock.ot.route_ot import router as ot_router
