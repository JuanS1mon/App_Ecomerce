...
async def get_institutions_html(request: Request, db: Session = Depends(get_db)):
    try:
        ...
        return templates.TemplateResponse("institutions/list.html", {
            "request": request,
...
async def get_create_institutions_html(request: Request):
    return templates.TemplateResponse("institutions/create.html", {"request": request})
...
async def get_edit_institutions_html(request: Request, id: int, db: Session = Depends(get_db)):
    try:
        ...
        return templates.TemplateResponse("institutions/edit.html", {
            "request": request,
