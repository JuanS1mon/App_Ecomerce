        ...
        for file in files:
            if file.endswith('.py'):
                ...
                try:
                    ...
                    # Reemplazar importaciones con 4 puntos por 3 puntos
...
if __name__ == "__main__":
    print("🔧 Corrigiendo importaciones con 4 puntos en Services...")
    fix_four_dot_imports()
