...
async def debug_table_info(
    ...
    try:
        ...
        try:
            ...
            """)
            exists_result = db.execute(exists_query, {"table_name": table_name})
            ...
            try:
                count_query1 = text(f"SELECT COUNT(*) as count FROM [{table_name}]")
                count_result1 = db.execute(count_query1)
            ...
            try:
                count_query2 = text(f"SELECT COUNT(1) as count FROM {table_name}")
                count_result2 = db.execute(count_query2)
            ...
            try:
                ...
                perms_result = db.execute(perms_query, {"table_name": table_name})
                permissions = []
