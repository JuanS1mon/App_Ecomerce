...
class DatabaseService:
    ...
    def get_all_tables(self) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            with get_db_session() as db:
                result = db.execute(query, {"schema_name": self.schema_name})
                tables = []
    ...
    def get_table_record_count(self, table_name: str) -> int:
        ...
        try:
            ...
            query = text(f"SELECT COUNT(*) as count FROM {safe_name}")
    ...
    def get_table_data(
        ...
        try:
            ...
            with get_db_session() as db:
                ...
                count_query = text(f"SELECT COUNT(*) as total FROM {safe_name}")
