...
from Services.app_stock.depositos.model_depositos import Depositos as DepositosModel
from Services.app_stock.depositos.schema_depositos import DepositosCreate, DepositosRead, DepositosUpdate
